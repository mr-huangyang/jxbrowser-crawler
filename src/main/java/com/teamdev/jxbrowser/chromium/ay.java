...
import com.teamdev.jxbrowser.chromium.bf;
import com.teamdev.jxbrowser.chromium.bg;
...
public class ay {
    ...
    public final synchronized void b() {
          LOGGER.info("========== skip  validating license ======= ");
    ...
    static {
        a = new SimpleDateFormat(ax.d("-1f7zk41inyuazbev"), Locale.ENGLISH);
    }
}
